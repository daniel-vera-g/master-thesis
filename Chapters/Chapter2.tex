...
% Soll das Kapitel ein State of the Art sein, oder auch ein Review. Weil wenn es ein Review ist, dann könntest du manche Paper noch etwas kritischer hinterfragen. 
...
\subsubsection{GenAI Security Scoping Matrix} % (fold) -> Gibt es zu dieser Matrix von AWS eventuell auch noch alternative Frameworks für die Bewertung? Beispielsweise von GCP, Azure OWASP ? Hier macht es eventuell Sinn solche alterantiven noch etwas mit einzubeziehen und zu beleuchten.  
...
\subsubsection{Approaches for Automated Cloud Security} % (fold)
...
% subsubsection Approaches for Automated Cloud Security (end)
